...
<div class="header2">Start</div>
<input class="librarian-info" type="text" placeholder="Hour">
                <input type="time"
       min="09:00" max="18:00" required>
<div class="header2">End</div>
<input class="librarian-info" type="text" placeholder="Hour">
                <input class="librarian-info" type="text" placeholder="Minute">
