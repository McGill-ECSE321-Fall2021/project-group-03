...
public class LibraryManagementRestController {
	...
	public LibrarianDto createLibrarian(@PathVariable("name") String name, @RequestParam String password, String email,
		...
		Librarian librarian = new Librarian(username, password, email, fullName, resAddress, isResident, library,
				staffSchedule);
...
=======
>>>>>>> 13c929c70a431c16897ef85285dad416382366a7
	...
	public RoomDto createRoom(@PathVariable("name") String name) {
		...
		int roomScheduleId = roomScheduleDto.getScheduleId();
		Room room = service.createRoom(roomScheduleDto, null);
