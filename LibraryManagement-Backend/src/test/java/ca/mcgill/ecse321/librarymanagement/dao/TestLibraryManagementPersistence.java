...
public class TestLibraryManagementPersistence {
	...
	public void testPersistAndLoadUser() {
		...
		User user = new User(userUsername, userPassword, userEmailaddress, userFullName, userResAddress, resident,
				library);
	...
	public void testPersistAndLoadLibrarian() {
		...
		Librarian librarian = new Librarian(librarianUsername, librarianPassword, librarianEmailaddress,
				librarianFullName, librarianResAddress, resident, library, staffSchedule);
	...
	public void testPersistAndLoadStaffSchedule() {
		//Create a library schedule, staff schedule and library.
		...
		HeadLibrarian headLibrarian = new HeadLibrarian(aUsername, aPassword, aEmailaddress, aFullName, aResAddress,
				aIsResident, library, staffSchedule);
		
		//add the librarian to the schedule.
		staffSchedule.addLibrarian(headLibrarian);
		...
		//check that the ids match and that the librarians were properly saved. 
		assertEquals(savedStaffScheduleId, savedStaffSchedule.getScheduleId());
		assertEquals(headLibrarian, savedStaffSchedule.getLibrarian(0));
	...
	public void testPersistAndLoadLibrary() {
		...
		// MusicAlbum title2 = new MusicAlbum(date2, "image2", "Music Album", "Adam
		// Geenen", 5, "Horror");
		...
		// assert that the retrieved library has the correct users with the
	...
	public void testPersistAndLoadLibrarySchedule() {
		...
		// create a second timeslot and add it to the library
